 ...
 * *Definition* = A sub-portion of the loop of Henle in the nephron of the kidney that is permeable to ions but not to water
 ...
 * *[database_cross_reference](../../ef/oboInOwl#hasDbXref.md)* = Wikipedia:Thin_ascending_limb_of_loop_of_Henle
