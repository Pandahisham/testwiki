 ...
 * *Definition* = A proximal phalanx that is part of a pedal digit 4 [Automatically generated definition].

## Synonyms

 * 4th toe proximal phalanx
 * foot digit 4 proximal phalanx
 * fourth proximal phalanx of foot
 * proximal phalanx of 4th toe
 * proximal phalanx of foot digit 4
 * proximal phalanx of fourth digit of foot
 ...
 * *[database_cross_reference](../../ef/oboInOwl#hasDbXref.md)* = SCTID:182155008
