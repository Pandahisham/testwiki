...
## Class : clavicle cartilage condensation

 * *IRI* = http://purl.obolibrary.org/obo/UBERON_0010843
 * *Label* = clavicle cartilage condensation
 * *Definition* = A cartilaginous condensation that has_potential_to_develop_into a clavicle.
