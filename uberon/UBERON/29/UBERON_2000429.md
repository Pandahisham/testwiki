 ...
 * *Label* = scaphium
 * *Definition* = Neural arch and Weberian ossicle that is reduced in size relative to other neural arches. Scaphium has a process which articulates with the first centrum.

## Synonyms

 * Weberian ossicle 2
 * second Weberian ossicle
